...
KNOWN_DOCKER_TAGS = ['impala-toolchain-centos6',
                     'impala-toolchain-centos7',
                     'impala-toolchain-debian7',
                     'impala-toolchain-debian8',
                     'impala-toolchain-ubuntu12',
                     'impala-toolchain-ubuntu14',
                     'impala-toolchain-ubuntu16',
                     'impala-toolchain-ubuntu18']
